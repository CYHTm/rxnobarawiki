    ...
    >
      ...
      >
        <div>
          ...
          <p>PortProton, Lesta Game Center и Tanks Blitz уже установлены. LACT тоже есть, но еще не открывался. Поэтому проверяем состояние, а не долбим кнопку установки второй раз. Отдельные экраны помощи, звука, устройств и быстрых команд остаются под рукой на случай, когда базовая настройка уже закончилась.</p>
        </div>
