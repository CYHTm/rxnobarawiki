...
const sources = [
  ...
  ["Secure Boot в Nobara не поддерживается", "https://wiki.nobaraproject.org/FAQ/FAQ#h-6-is-nobara-compatible-with-secureboot"],
  ...
  ["FLClash, релизы Linux AppImage", "https://github.com/chen08209/FlClash/releases/latest"],
  ["Karing, загрузка Linux", "https://karing.app/download"],
  ["Karing, релизы GitHub", "https://github.com/KaringX/karing/releases/latest"],
  ["v2rayN для Linux, замена V2RayTun", "https://github.com/2dust/v2rayN/releases/latest"],
  ["v2rayN: какие ядра поддерживаются", "https://github.com/2dust/v2rayN/wiki/List-of-supported-cores"],
