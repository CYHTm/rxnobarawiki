...
export function SectionCard({ id, number, title, description, children }: SectionCardProps) {
  return (
    <motion.section
      ...
      className="scroll-mt-24 border-t border-zinc-500/60 py-12 first:border-t-0 first:pt-0 sm:py-16"
    >
      <div className="mb-9 grid gap-3 sm:grid-cols-[56px_1fr]">
        ...
        <div>
          ...
          <p className="mt-3 max-w-2xl text-sm leading-6 text-zinc-200 sm:text-[15px]">{description}</p>
        </div>
      </div>
