...
3. `/battle` - последовательный интерактивный бой Windows 11 и Nobara. Он не входит в нумерацию, карту и порядок разделов гайда.

Внутри гайда есть карта маршрута и двенадцать тематических экранов, всего тринадцать самостоятельных экранов:
...
- клиент подписки: FLClash и Karing с официального GitHub/сайта как AppImage, v2rayN как Linux-замена V2RayTun, без Fedora-репозиториев и второго TUN;
...
- Windows UTC, GRUB, порядок загрузки после обновлений Windows и Nobara Drive Mount Manager;
...
- `app/battle/page.tsx` - отдельный маршрут линейной пасхалки вне гайда;
- `components/welcome` - стартовый экран и переход во внутрь;
- `components/battle/BattleApp.tsx` - последовательный бой с непостоянным состоянием;
